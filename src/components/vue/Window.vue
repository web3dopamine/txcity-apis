<template>
	<div @mousedown="moveToFront" :id="windowId" class="window-modal canvas-overlay"
		:style="'border-color:#' + $parent.coinConfig.color + '40'" :class="[
		...
		<div class="modal-card">
			<header :data-move-id="windowId" class="modal-card-head"
			...
			<section class="modal-card-body">
				<div v-for="comp in windowData.components" :key="comp.key">
					<component v-if="$root.isConnected || comp.name == 'settings'" v-bind="comp.props" :is="comp.name">
					</component>
...
import LoadHouse from "./LoadHouse.vue";
